              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      TableCell(child: Center(child: SelectableText('BEACON', style: TextStyle(color: textColor)))),
                      TableCell(child: Center(child: SelectableText('X-Coordinates', style: TextStyle(color: textColor)))),
                      TableCell(child: Center(child: SelectableText('Y-Coordinates', style: TextStyle(color: textColor)))),
                      TableCell(child: Center(child: SelectableText('Y(I)*(X(I+1)-X(I))', style: TextStyle(color: textColor)))),
                      TableCell(child: Center(child: SelectableText('X(I)*(Y(I+1)-Y(I))', style: TextStyle(color: textColor)))),
                    ],
                  ),
                  for (int i = 0; i < filteredCoordinates.length; i++)
                    TableRow(
                      decoration: BoxDecoration(color: cellColor),
                      children: [
                        TableCell(child: Center(child: SelectableText(filteredCoordinates[i].beacon, style: TextStyle(color: textColor)))),
                        TableCell(child: Center(child: SelectableText(filteredCoordinates[i].x.toStringAsFixed(2), style: TextStyle(color: textColor)))),
                        TableCell(child: Center(child: SelectableText(filteredCoordinates[i].y.toStringAsFixed(2), style: TextStyle(color: textColor)))),
                        TableCell(
                          child: Center(
