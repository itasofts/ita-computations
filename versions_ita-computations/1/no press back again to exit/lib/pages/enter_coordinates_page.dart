        ...
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
              ...
              PopupMenuItem<String>(
                enabled: true, // Disable selection
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Container(
                    width: 200, // Approx. 20 letters wide
                    child: TextField(
    ...
    setState(() {
      for (String line in lines) {
        ...
        if (values.length >= 2) {
          ...
          String beacon = values.length > 2 ? values.sublist(2).join(' ') : ''; // Join remaining parts as beacon
